...
<style scoped>
    ...
    main.processing section[role=controlls] {
        opacity: 0 !important;
    }
    ...
    main section[role=controlls] button#remove:focus {
        opacity: .75;
    }
