          ...
          return new Promise(function (resolve, reject) {
            if (_this.editable) {
              if (_this._events.ondrop) _this.$emit('ondrop', {
                ...
                _this.process_file(file).then(function (image) {
                  return _this.add_image(image, cell) && resolve();
                });
              }
            } else resolve();
